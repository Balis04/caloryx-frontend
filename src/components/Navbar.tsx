      ...
      <div className="container mx-auto px-4 py-3 md:px-6">
        ...
        <div className="hidden grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-4 md:grid lg:gap-6">
          ...
          <div className="flex shrink-0 items-center gap-2 justify-self-end">
            {isAuthenticated ? (
              <>
                <div className="max-w-[160px] rounded-full border border-white/70 bg-white/65 px-4 py-2 text-sm text-slate-600 shadow-sm backdrop-blur lg:max-w-[200px] xl:max-w-none">
        ...
        {isMobileMenuOpen ? (
          <div className="mt-4 space-y-4 rounded-[28px] border border-white/70 bg-white/70 p-4 shadow-sm backdrop-blur md:hidden">
            ...
            <div className="flex flex-col gap-2 border-t border-slate-200/70 pt-4">
              {isAuthenticated ? (
                <>
                  <div className="rounded-full border border-white/70 bg-white/65 px-4 py-2 text-sm text-slate-600 shadow-sm backdrop-blur">
