...
export default function CoachTrainingRequestsWorkspace({
  trainingRequests,
}: {
  ...
  const {
    ...
    expandedApprovedRequestId, isCoach, loading, profileLoading, savingApprovedRequestId,
    trainingPlanDrafts, updatingRequestId, visibleRequests, downloadTrainingPlan,
    setDecisionDescription, toggleApprovedRequestEditor, saveTrainingPlan,
    setCoachRequestFilter, setCoachViewMode, updateTrainingPlanDraft, updateRequestStatus,
  } = trainingRequests;
    ...
    <CaloriexPage>
      ...
      <section className="relative container mx-auto px-6 pb-12 md:pb-16">
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.65fr)_340px]">
          <TrainingRequestsContent coachRequestFilter={coachRequestFilter} coachViewMode={coachViewMode} decisionDescriptions={decisionDescriptions} downloadingRequestId={downloadingRequestId} error={error} expandedApprovedRequestId={expandedApprovedRequestId} isCoach={isCoach} onDecisionDescriptionChange={setDecisionDescription} onDownloadTrainingPlan={downloadTrainingPlan} onFilterChange={setCoachRequestFilter} onSaveTrainingPlan={saveTrainingPlan} onToggleTrainingPlanEditor={toggleApprovedRequestEditor} onTrainingPlanDraftChange={updateTrainingPlanDraft} onUpdateRequestStatus={updateRequestStatus} onViewModeChange={setCoachViewMode} savingApprovedRequestId={savingApprovedRequestId} showCoachIncomingRequests={showCoachIncomingRequests} trainingPlanDrafts={trainingPlanDrafts} updatingRequestId={updatingRequestId} visibleRequests={visibleRequests} />
