...
export default function TrainingRequestFormCard({
  formData,
  goalLabel,
  activityLevelLabel,
  selectedCoach,
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <ReadonlyField
              ...
              fallback="Add your current weight on the profile page"
            />
            <ReadonlyField
              label="Target weight"
              value={formData.targetWeightKg}
              fallback="Add your target weight on the profile page"
            />
            <ReadonlyField
              label="Goal"
              value={goalLabel}
              fallback="Set your goal on the profile page"
            />
            <ReadonlyField
              label="Activity level"
              value={activityLevelLabel}
              fallback="Set your activity level on the profile page"
            />
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) => onFieldChange("weeklyWorkouts", event.target.value)}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) => onFieldChange("preferredSessionLength", event.target.value)}
              />
            </div>
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Input
                ...
                onChange={(event) => onFieldChange("trainingLocation", event.target.value)}
              />
            </div>
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <textarea
                ...
                onChange={(event) => onFieldChange("customerDescription", event.target.value)}
